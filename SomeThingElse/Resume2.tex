...
\begin{itemize}
  \item 实现用户登陆，注册，添加商品，删除商品，购买下单
  \item 使用自定义AOP注解实现计算方法执行时间的功能
  \item Spring-Security 实现鉴证，授权
  \item Spring-Jpa 实现数据库交互
\end{itemize}
...
\begin{itemize}[parsep=0.5ex]
  ...
  \item 了解IoC，AOP，MVC概念，了解Spring-Boot，及相关组件(Security,Jpa)
  \item 熟悉常用网络协议TCP，HTTP
  \item 熟悉常用开发工具(IDEA, Git, Github， Maven)
\end{itemize}
